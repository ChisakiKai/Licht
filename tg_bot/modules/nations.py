...
nations = """ Licht has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats Licht is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Licht.
\n*Sakuras* - Have access go globally ban users across Licht.
...
\n*Disclaimer*: The Nation levels in Licht are there for troubleshooting, support, banning potential scammers.
